...
def large_num_thm (n, distribution):
    ...
    plt.savefig("large_num_thm_kai.png")
...
def central_limit_thm (k,n,distribution,mu,sigma):
    ...
    plt.savefig("central_lim_thm_kai.png")

if __name__ == "__main__" :
    large_num_thm (1000,kai_distribution(2))
    central_limit_thm(1000000,100,kai_distribution(2),2,4)
